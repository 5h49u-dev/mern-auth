...
const Header = () => {
  ...
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-800'>
        ...
        font-medium mb-2'>Hey {userData ? userData.name : 'Developer'}!<img className='w-8 aspect-square' src={assets.hand_wave}/></h1>
        ...
        <button className='border border-gray-500 rounded-full px-8 py-2.5 hover:bg-gray-200 transisition-all'>Get Started</button>
    </div>
  )
}
